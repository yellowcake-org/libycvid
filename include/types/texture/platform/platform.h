...
typedef yc_vid_status_t (yc_vid_texture_create_t)(yc_vid_texture_data_t *, yc_vid_texture_handle_t **result);
...
typedef yc_vid_status_t (yc_vid_texture_set_visibility_t)(yc_vid_texture_handle_t *, yc_vid_texture_visibility_t);
